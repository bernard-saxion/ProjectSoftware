...
\begin{gantt}{21}{8}
	...
	\ganttbar{Site acceptance test}{0}{1}
	\ganttbarcon[pattern=crosshatch]{}{1}{0.5}

	\ganttmilestone{Project setup}{1}

	\ganttgroup{Design documents}{1}{2}
	\ganttbar{Hardware schematic}{1}{1}
	\ganttbarcon[pattern=crosshatch]{}{2}{1}
	\ganttbar{Subsystem tests}{2}{0.5}
	\ganttbar{Software flowchart}{1.5}{1.5}
	\ganttbar{Interface design}{1.1}{0.1}
	\ganttbar{Integration test}{2.5}{0.5}
